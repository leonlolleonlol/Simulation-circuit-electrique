...
function testColor(){
  ...
  noStroke();
  let grad = drawingContext.createRadialGradient(resisteur.x-25, resisteur.y-25, 10, resisteur.x + 25, resisteur.y + 25, 110);
  grad.addColorStop(0,"#40E0D0");
  grad.addColorStop(1,"#FF8C00");
  drawingContext.fillStyle=grad;
  rect(resisteur.x, resisteur.y, resisteur.taille);
  fill('#a358a8');
